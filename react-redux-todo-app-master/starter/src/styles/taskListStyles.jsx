...
// const taskAdded = createAction("taskUpdated");
// const taskCompleted = createAction();
// const taskUpdated = createAction();
// const taskDeleted = createAction();

// console.log(
//   taskAdded({ task: "This is better", priority: "high", category: "weekday" })
// );
...
export const StyledCross = styled(Cross2Icon, {
  color: violet.violet10,
  //   transition: "transform 300ms cubic-bezier(0.87, 0, 0.13, 1)",
  //   "[data-state=open] &": { transform: "rotate(180deg)" },
});
